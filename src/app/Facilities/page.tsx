...
export default function Facilities() {
  const facilities = [
    ...
    },
    {
      ...
      description: "Safe and reliable transport facilities for students.",
      icon: <Bus className="w-10 h-10 text-orange-600" />,
    },
    {
      title: "Sports & Playground",
      description: "Encouraging physical fitness and extracurricular activities.",
      icon: <Volleyball className="w-10 h-10 text-purple-600" />,
    },
    {
      title: "Secure Environment",
      description: "Safe, supportive, and inclusive campus environment.",
      icon: <Shield className="w-10 h-10 text-red-600" />,
    },
  ];

  return (
    <section className="py-16 bg-gray-50" id="facilities">
